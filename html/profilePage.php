   ...
   <tr height="50">
      <td height="83" colspan="2" bgcolor="white">
         <table title="Banner" id="banner" border="0">
            <tr><td width="1195"><a href="images/banner.jpg" title="TheHoneycombBanner1 by devgurl36!, on Flickr"><img src="http://farm9.staticflickr.com/8170/7980116517_004c52431c_b.jpg" width="1157" height="137" alt="TheHoneycombBanner1"></a></td></tr>
         </table>
      </td>
   </tr>
   <tr height="200">
...
<input type="submit" value="Upload File" />
			...
			<tr> <td><a href="<?php echo "$FILE_URL/$_SESSION[user_name]"; ?>">User directory</a> </td><tr> <tr> <td><a href="<?php echo "$URL_BASE/login.php?logout"; ?>">Logout</a> </td><tr>
         </table>
      </td>
   </tr>
</table>
